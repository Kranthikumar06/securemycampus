        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3xl items-center">
          <div className="order-2 lg:order-1">
            <div 
              ...
              aria-label="A cinematic view of Anurag University building at sunset"
            ></div>
          </div>
          <div className="order-1 lg:order-2 space-y-lg">
            ...
            <p className="font-body-lg text-on-surface-variant leading-relaxed">
              At Anurag University, we believe that academic excellence thrives in a safe and secure environment. The 'Secure My Campus' initiative is more than just a reporting tool; it's a commitment to every member of our campus family.
            </p>
            <p className="font-body-lg text-on-surface-variant leading-relaxed">
